...
@section('content')
    ...
    <div class="max-w-2xl mx-auto mt-5 mb-5 bg-white p-8 rounded-xl shadow-lg border border-rose-100">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-rose-700">Thêm Khóa Sinh Viên Mới</h2>
            <a href="{{ route('admin/course') }}" class="inline-block">
                <button type="button"
        ...
        <form action="{{ route('admin/course/post') }}" method="POST" class="space-y-6">
            @csrf
