                        ...
                        <div class="mt-2 flex gap-4">
                            <label class="flex items-center gap-2 text-gray-700">
                                <input type="radio" name="gender" value="1"
                                    ...
                                    {{ isset($old['gender']) && $old['gender'] === 1 ? 'checked' : '' }}>
                                Nam
                            </label>
                            <label class="flex items-center gap-2 text-gray-700">
                                <input type="radio" name="gender" value="0"
                                    class="text-rose-500 focus:ring-rose-500"
                                    {{ isset($old['gender']) && $old['gender'] === 0 ? 'checked' : '' }}>
                                Nữ
                            </label>
                        </div>
                    </div>
                        ...
                        <select name="major_id" id="major_id"
                            ...
                            @foreach ($majors as $major)
                                <option value="{{ $major->id }}" 
                                    {{ isset($old['major_id']) && $old['major_id'] == $major->id ? 'selected' : '' }}>
                                    {{ $major->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="course_id" id="course_id"
                            ...
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}">
                                    {{ isset($old['course_id']) && $old['course_id'] == $course->id ? 'selected' : '' }}
                                    {{ $course->name }}
                            </option>
                            @endforeach
                        </select>
